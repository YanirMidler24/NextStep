...
export function ShareButtons() {
  return (
    <div
      ...
      role="group"
      aria-label="שתף בפלטפורמות חברתיות"
    >
      <button
        onClick={() => shareOnSocial("linkedin")}
        aria-label="שתף בלינקדאין"
        className="text-gray-300 hover:text-blue-700 transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-black rounded-md p-2"
        type="button"
      >
        <svg
          className="h-6 w-6"
        ...
        <span className="sr-only">שתף בלינקדאין</span>
      </button>
      <button
        onClick={() => shareOnSocial("whatsapp")}
        aria-label="שתף בווטסאפ"
        className="text-gray-300 hover:text-green-500 transition focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-black rounded-md p-2"
        type="button"
      >
        <svg
          className="h-7 w-7"
        ...
        <span className="sr-only">שתף בווטסאפ</span>
      </button>
    </div>
  );
}