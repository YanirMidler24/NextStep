export const ABOUT_CONTENT = {
  ...
  description: [
    ...
    "הייתי בדיוק במקום שאתה נמצא בו עכשיו – מבולבל, חסר ביטחון, לא בטוח מאיפה להתחיל. לכן יצרתי את 'הצעד הבא'. כי גם אני הייתי שם – והצלחתי להתקדם.\n\n",

    "למה לבחור בי? כי עבדתי בכל סוג של סביבה: בחברה קטנה שבה עושים הכול – פיתוח, קשר ישיר עם לקוחות, עבודה מול CTO ו-CEO. בחברת מוצר – ניהול פיצ'רים, SEO, והרחבת המוצר לפרויקטים חדשים. וגם בחברה גדולה עם מאות עובדים – עבודה בצוותים, בפרויקטים מקבילים, מול לקוחות ענק.\n\n",

    "המטרה שלי ברורה: לבנות איתך מסלול אישי ומדויק, עם ליווי מקצועי, כלים פרקטיים, והמון אמונה בדרך שלך.",
  ],
  keyPoints: [
