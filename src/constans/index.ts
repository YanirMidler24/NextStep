export const ABOUT_CONTENT = {
  ...
  description: [
    ...
    "ומה נתן לי את הכלים ללוות גם אחרים? עבדתי כמעט בכל סוג של סביבה: בחברה קטנה שבה עושים הכול – פיתוח פרויקטים מקצה לקצה, קשר עם לקוחות, עבודה ישירה מול CTO ו-CEO. בחברת מוצר – שם ניהלתי פיצ’רים, עבדתי על SEO, והובלתי פרויקטים חדשים. בחברה גדולה פיתוח פרויקטים בSCALE גדול,  עבודה מול צוותים מרובים ולקוחות ענק. כל זה מאפשר לי להבין את הדרך מכל זווית – ולהעביר את הידע הזה הלאה.",
